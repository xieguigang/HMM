...
Namespace ChatGLM
    ...
    Public Class ChatHistory
        ...
        Public Function AddAIResponse(content As String) As ChatHistory
            history.Add(New History With {.role = roles.assistant, .content = content, .metadata = ""})
            Return Me
        End Function

        Public Function AddUserInput(content As String) As ChatHistory
            history.Add(New History With {.role = roles.user, .metadata = Nothing, .content = content})
            Return Me
        End Function
