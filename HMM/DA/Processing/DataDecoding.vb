...
Namespace DA.Processing
	...
	Public Class DataDecoding
		Private ReadOnly OUTER_SPLITTER As String = ", "
		Private ReadOnly INNER_SPLITTER As String = "->"
		Private Shared ourInstance As New DataDecoding

        Public Shared ReadOnly Property Instance As DataDecoding
            Get
                Return ourInstance
            End Get
        End Property
		...
		Public Overridable Function getModelName(ByVal nameInJson As String) As String
			Return nameInJson
		End Function
		...
		Public Overridable Function getModelCreationDate(ByVal dateInJson As String) As String
			Return dateInJson
		End Function
		...
		Public Overridable Function getModelCreationPurpose(ByVal purposeInJson As String) As String
		...
		Public Overridable Function getStates(ByVal statesInJson As String) As List(Of String)
		...
		Public Overridable Function getInitialProbabilities(ByVal initialProbabilitiesInJson As String) As Dictionary(Of String, Double)
		...
		Public Overridable Function getObservations(ByVal observationsInJson As String) As List(Of String)
		...
		Public Overridable Function getTransitionMatrix(ByVal transitionMatrixInJson As String) As Dictionary(Of KeyValuePair(Of String, String), Double)
		...
		Public Overridable Function getEmissionMatrix(ByVal emissionMatrixInJson As String) As Dictionary(Of KeyValuePair(Of String, String), Double)
